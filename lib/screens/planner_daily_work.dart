...
class PlannerDailyWork extends StatefulWidget {
  const PlannerDailyWork({super.key});

  @override
  State<PlannerDailyWork> createState() => _PlannerDailyWorkState();
}

class _PlannerDailyWorkState extends State<PlannerDailyWork> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Planner Daily Work Report', 25, appColors.primaryColor,
