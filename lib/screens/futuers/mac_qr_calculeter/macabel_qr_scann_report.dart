...
class MacabelQrScannReport extends StatefulWidget {
  const MacabelQrScannReport({super.key});

  @override
  State<MacabelQrScannReport> createState() => _MacabelQrScannReportState();
}

class _MacabelQrScannReportState extends State<MacabelQrScannReport> {
  int selectedIndex = 0;
          ...
          Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(flex: 50, child: buildInputColumn('Box No')),
                  SizedBox(width: 5),
                  Expanded(flex: 25, child: buildInputColumn('')),
                  textScreen('To', 20, appColors.primaryColor, FontWeight.w500,
                      TextAlign.center),
                  Expanded(flex: 25, child: buildInputColumn('')),
                ],
              ),
