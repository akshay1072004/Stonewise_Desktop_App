...
class KapanMassster extends StatefulWidget {
  const KapanMassster({super.key});

  @override
  State<KapanMassster> createState() => _KapanMasssterState();
}

class _KapanMasssterState extends State<KapanMassster> {
  int selectedIndex = 0;
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      Expanded(child: buildInputColumn2('Kapan No.', 'z46')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child: buildInputColumn2('Main Kapan No.', 'z46')),
                      SizedBox(width: 10),
                      Expanded(child: buildInputColumn2('SubKapan No.', 'z46')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child:
                              buildInputColumn2('Weight gain in lotting', 'j')),
                      SizedBox(width: 10),
                      Expanded(
                          child: buildInputColumn2('Sub Kapan Weight', 'hb')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child: buildInputColumn2(
                              'Weight gain in lottery', 'bhb')),
                      SizedBox(width: 10),
                      Expanded(child: buildInputColumn2('Rough Name', 'bhj')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                  ...
                  Row(
                    children: [
                      Expanded(child: buildInputColumn2('Rate', 'bh')),
                      SizedBox(width: 10),
                      Expanded(child: buildInputColumn2('Total Amount', 'bh')),
                    ],
                  ),
                  SizedBox(height: 20),
                  Padding(
