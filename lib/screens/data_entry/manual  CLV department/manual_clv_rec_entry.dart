...
class ManualClvRecEntry extends StatefulWidget {
  const ManualClvRecEntry({super.key});

  @override
  State<ManualClvRecEntry> createState() => _ManualClvRecEntryState();
}

class _ManualClvRecEntryState extends State<ManualClvRecEntry> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Manual CLV.Rec Entry', 25, appColors.primaryColor,
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: buildInputColumn5('Deposite Date')),
                      SizedBox(width: 5),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 5),
                      Expanded(
                          flex: 10, child: buildInputColumn2('Weight', '')),
                      SizedBox(width: 5),
                      Expanded(flex: 10, child: buildInputColumn2('%', '')),
                      SizedBox(width: 5),
                      Expanded(
                          flex: 25,
                          child: buildInputColumn2('Sarain Police Weight', '')),
                      SizedBox(width: 5),
                      Expanded(
                          flex: 30,
                          child: buildInputColumn2(
                              'Sarain Police Percentage', '')),
                      SizedBox(width: 5),
                      Expanded(
                        flex: 25,
                        child: Column(
                  ...
                  Row(
                    children: [
                      Expanded(child: buildInputColumn5('Sent date')),
                      SizedBox(width: 5),
                      Expanded(child: buildInputColumn2('Process', '')),
                      SizedBox(width: 5),
                      Expanded(child: buildInputColumn2('Total weight', '')),
                      SizedBox(width: 5),
                      Expanded(child: buildInputColumn2('Rec.Lotting Wt.', '')),
                      SizedBox(width: 5),
                      Expanded(child: buildInputColumn2('Rec.Lotting Wt.', '')),
                      SizedBox(width: 5),
                      Expanded(child: buildInputColumn2('Rec.Reje.Wt.', '')),
                      SizedBox(width: 5),
