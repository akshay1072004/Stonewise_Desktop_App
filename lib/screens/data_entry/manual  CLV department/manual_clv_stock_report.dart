...
class ManualClvStockReport extends StatefulWidget {
  const ManualClvStockReport({super.key});

  @override
  State<ManualClvStockReport> createState() => _ManualClvStockReportState();
}

class _ManualClvStockReportState extends State<ManualClvStockReport> {
  int selectedIndex = 0;
  String? selectedValue;
  String? selectedValue1;
  String? selectedProcess;
  String? selectedMain;
  String? selectedMainkapan;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Manual CLV.Stock Report', 25, appColors.primaryColor,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonDropdownButton(
                              items: [
                                'Kapan Process Wise Stock Report',
                                'Employee Wise Daily stock Report',
                                'Manager Wise Daily stock Report',
                                'All Kapan Wise Stock Reprt',
                              ],
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonDropdownButton(
                              ...
                              initalValue: selectedMainkapan,
                              onChange: (p0) {
                                setState(() {
                                  selectedMainkapan = p0;
                                });
                              },
                            )
                          ],
