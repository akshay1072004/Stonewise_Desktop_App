...
class ClvProcessMaster extends StatefulWidget {
  const ClvProcessMaster({super.key});

  @override
  State<ClvProcessMaster> createState() => _ClvProcessMasterState();
}

class _ClvProcessMasterState extends State<ClvProcessMaster> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Process Details', 25, appColors.primaryColor,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      Expanded(
                          child: buildInputColumn2('Process Type', 'Galaxy')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(child: buildInputColumn2('Pyority No', 'gsasd')),
                      SizedBox(width: 10),
                      Expanded(
                          child: buildInputColumn2('Pyority Name', 'gsasd')),
                    ],
                  ),
                  SizedBox(height: 20),
                   Padding(
