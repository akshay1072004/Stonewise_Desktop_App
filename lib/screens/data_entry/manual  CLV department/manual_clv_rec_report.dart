...
class ManualClvRecReport extends StatefulWidget {
  const ManualClvRecReport({super.key});

  @override
  State<ManualClvRecReport> createState() => _ManualClvRecReportState();
}

class _ManualClvRecReportState extends State<ManualClvRecReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Manual CLV.Rec Report', 25, appColors.primaryColor,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonDropdownButton(
                              items: [
                                'OFFICE RECIEVE',
                                'OFFICE ISSUE REC LEDGER REPORT',
                              ],
