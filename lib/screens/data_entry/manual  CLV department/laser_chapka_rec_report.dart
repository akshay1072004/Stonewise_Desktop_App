...
class LaserChapkaRecReport extends StatefulWidget {
  const LaserChapkaRecReport({super.key});

  @override
  State<LaserChapkaRecReport> createState() => _LaserChapkaRecReportState();
}

class _LaserChapkaRecReportState extends State<LaserChapkaRecReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Laser Rec.Refreh', 25, appColors.primaryColor,
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 5),
                        Expanded(child: buildbotton(3, 'Exit')),
                      ],
                    ),
                  ),
                  SizedBox(height: 20),
