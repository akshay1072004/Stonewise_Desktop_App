...
class CleavingIssueRecEntry extends StatefulWidget {
  const CleavingIssueRecEntry({super.key});

  @override
  State<CleavingIssueRecEntry> createState() => _CleavingIssueRecEntryState();
}

class _CleavingIssueRecEntryState extends State<CleavingIssueRecEntry> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Cleaving: Issue - Receive Entry', 25,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 5),
                      Expanded(
                          flex: 10, child: buildInputColumn2('Rej.Cts', '1')),
                      SizedBox(width: 5),
                      Expanded(
                          flex: 15,
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 5),
                      Expanded(
                          flex: 10, child: buildInputColumn2('Uncat Pcs', '1')),
                      SizedBox(width: 5),
                      Expanded(
                          flex: 10, child: buildInputColumn2('Uncat Cts', '1')),
                      SizedBox(width: 5),
                      Expanded(
