...
class GalaxyLottingReport extends StatefulWidget {
  const GalaxyLottingReport({super.key});

  @override
  State<GalaxyLottingReport> createState() => _GalaxyLottingReportState();
}

class _GalaxyLottingReportState extends State<GalaxyLottingReport> {
  int selectedIndex = 0;
  String? selectedValue;
  String? selectedValue1;
  String? selectedValueMain;
  String? selectedValueKapan;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Galaxy Lotting Report', 25, appColors.primaryColor,
              ...
              child: Column(
                children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonDropdownButton(
                              ...
                              initalValue: selectedValueMain,
                              onChange: (p0) {
                                setState(() {
                                  selectedValueMain = p0;
                                });
                              },
                            )
                          ],
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonDropdownButton(
                              ...
                              initalValue: selectedValueKapan,
                              onChange: (p0) {
                                setState(() {
                                  selectedValueKapan = p0;
                                });
                              },
                            )
                          ],
                  ...
                  Row(
                    children: [
                      Expanded(
                          flex: 25, child: buildInputColumn2('Lot No', '')),
                      Text(
                        'TO',
                        style: TextStyle(
                            color: appColors.primaryColor, fontSize: 14),
                      ),
                      Expanded(flex: 25, child: buildInputColumn2('', '')),
                      SizedBox(width: 10),
