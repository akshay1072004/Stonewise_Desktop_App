...
class StockTally extends StatefulWidget {
  const StockTally({super.key});

  @override
  State<StockTally> createState() => _StockTallyState();
}

class _StockTallyState extends State<StockTally> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Stock Tally Searching Forms', 25,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 5),
                        Expanded(child: buildInputColumn2('Lot No.', '')),
                        Text('TO',
                    ...
                    Row(
                      children: [
                        Text('Stk', style: TextStyle(fontSize: 16)),
                        SizedBox(width: 120),
                        Text('Chack Stock', style: TextStyle(fontSize: 22)),
                        SizedBox(width: 400),
                        Text('Tally Stock', style: TextStyle(fontSize: 22)),
                        SizedBox(width: 160),
                        Text('Stk', style: TextStyle(fontSize: 16)),
                      ],
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(child: buildbotton(1, 'View Stock')),
                          SizedBox(width: 5),
                          Expanded(child: buildbotton(2, 'Reset')),
                        ],
                      ),
                    ),
                    SizedBox(height: 20),
