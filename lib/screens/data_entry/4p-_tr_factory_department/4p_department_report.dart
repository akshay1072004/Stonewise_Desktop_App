...
class FourDepartmentReport extends StatefulWidget {
  const FourDepartmentReport({super.key});

  @override
  State<FourDepartmentReport> createState() => _FourDepartmentReportState();
}

class _FourDepartmentReportState extends State<FourDepartmentReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('4P : Issue - Recevive Report', 25,
