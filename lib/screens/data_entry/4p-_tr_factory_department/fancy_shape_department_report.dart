...
class FancyShapeDepartmentReport extends StatefulWidget {
  const FancyShapeDepartmentReport({super.key});

  @override
  State<FancyShapeDepartmentReport> createState() =>
      _FancyShapeDepartmentReportState();
}

class _FancyShapeDepartmentReportState
    extends State<FancyShapeDepartmentReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Fancy : Issue - Recevive Report', 25,
