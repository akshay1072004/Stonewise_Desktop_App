...
class TrDepartmentEntry extends StatefulWidget {
  const TrDepartmentEntry({super.key});

  @override
  State<TrDepartmentEntry> createState() => _TrDepartmentEntryState();
}

class _TrDepartmentEntryState extends State<TrDepartmentEntry> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('TR : Issue - Recevive Entry', 25,
