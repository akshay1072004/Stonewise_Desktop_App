...
class SarinDepartmentEnty extends StatefulWidget {
  const SarinDepartmentEnty({super.key});

  @override
  State<SarinDepartmentEnty> createState() => _SarinDepartmentEntyState();
}

class _SarinDepartmentEntyState extends State<SarinDepartmentEnty> {
  int selectedIndex = 0;
