...
class FactoryDepartmentReport extends StatefulWidget {
  const FactoryDepartmentReport({super.key});

  @override
  State<FactoryDepartmentReport> createState() =>
      _FactoryDepartmentReportState();
}

class _FactoryDepartmentReportState extends State<FactoryDepartmentReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Factory : Issue - Recevive Report', 25,
