...
class FactoryDepartmentEntry extends StatefulWidget {
  const FactoryDepartmentEntry({super.key});

  @override
  State<FactoryDepartmentEntry> createState() => _FactoryDepartmentEntryState();
}

class _FactoryDepartmentEntryState extends State<FactoryDepartmentEntry> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Factory : Issue - Recevive Entry', 25,
