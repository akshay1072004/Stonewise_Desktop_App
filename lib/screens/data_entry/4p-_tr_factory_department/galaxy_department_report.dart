...
class GalaxyDepartmentReport extends StatefulWidget {
  const GalaxyDepartmentReport({super.key});

  @override
  State<GalaxyDepartmentReport> createState() => _GalaxyDepartmentReportState();
}

class _GalaxyDepartmentReportState extends State<GalaxyDepartmentReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Galaxy : Issue - Recevive Report', 25,
