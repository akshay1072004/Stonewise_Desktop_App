...
class LaserIssueRecReport extends StatefulWidget {
  const LaserIssueRecReport({super.key});

  @override
  State<LaserIssueRecReport> createState() => _LaserIssueRecReportState();
}

class _LaserIssueRecReportState extends State<LaserIssueRecReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Laser : Issue - Recevive Report', 25,
