...
class FancyShapeDepartmentEntry extends StatefulWidget {
  const FancyShapeDepartmentEntry({super.key});

  @override
  State<FancyShapeDepartmentEntry> createState() =>
      _FancyShapeDepartmentEntryState();
}

class _FancyShapeDepartmentEntryState extends State<FancyShapeDepartmentEntry> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Fancy : Issue - Recevive Entry', 25,
