...
class LaserIssueRecEntry extends StatefulWidget {
  const LaserIssueRecEntry({super.key});

  @override
  State<LaserIssueRecEntry> createState() => _LaserIssueRecEntryState();
}

class _LaserIssueRecEntryState extends State<LaserIssueRecEntry> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Laser : Issue - Recevive Entry', 25,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 5),
                          Expanded(child: buildbotton(10, 'Search Lot')),
                        ],
                      ),
                    ),
                    SizedBox(height: 20),
