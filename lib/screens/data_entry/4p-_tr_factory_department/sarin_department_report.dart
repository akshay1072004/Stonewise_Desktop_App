...
class SarinDepartmentReport extends StatefulWidget {
  const SarinDepartmentReport({super.key});

  @override
  State<SarinDepartmentReport> createState() => _SarinDepartmentReportState();
}

class _SarinDepartmentReportState extends State<SarinDepartmentReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('Sarin : Issue - Recevive Report', 25,
