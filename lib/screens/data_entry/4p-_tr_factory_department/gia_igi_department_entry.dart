...
class GiaIgiDepartmentEntry extends StatefulWidget {
  const GiaIgiDepartmentEntry({super.key});

  @override
  State<GiaIgiDepartmentEntry> createState() => _GiaIgiDepartmentEntryState();
}

class _GiaIgiDepartmentEntryState extends State<GiaIgiDepartmentEntry> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('GIA/IGI : Issue - Recevive Entry', 25,
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 5),
                        Expanded(
                            flex: 10, child: buildInputColumn5('Rec Date')),
                        SizedBox(width: 5),
                        Expanded(flex: 10, child: buildInputColumn2('No', '')),
                        SizedBox(width: 5),
                        Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CommonDropdownButton(
                                ...
                                initalValue: selectedEmployee2,
                                onChange: (p0) {
                                  setState(() {
                                    selectedEmployee2 = p0;
                                  });
                                },
                              )
                            ],
