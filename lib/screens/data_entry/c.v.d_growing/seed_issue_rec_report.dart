...
class SeedIssueRecReport extends StatefulWidget {
  const SeedIssueRecReport({super.key});

  @override
  State<SeedIssueRecReport> createState() => _SeedIssueRecReportState();
}

class _SeedIssueRecReportState extends State<SeedIssueRecReport> {
  int selectedIndex = 0;
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: buildInputColumn('Process Name')),
                      SizedBox(width: 10),
                      Expanded(child: buildInputColumn('Employee Name')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                  ...
                  Row(
                    children: [
                      Expanded(
                          flex: 50, child: buildInputColumn('Seed Box No')),
                      SizedBox(width: 10),
