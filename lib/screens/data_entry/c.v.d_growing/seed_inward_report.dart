...
class SeedInwardReport extends StatefulWidget {
  const SeedInwardReport({super.key});

  @override
  State<SeedInwardReport> createState() => _SeedInwardReportState();
}

class _SeedInwardReportState extends State<SeedInwardReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        ...
        child: Column(
          children: [
            ...
            textScreen('SEED INWORD REPORT', 25, appColors.primaryColor,
