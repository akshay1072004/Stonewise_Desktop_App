...
class FactoryMaster extends StatefulWidget {
  const FactoryMaster({super.key});

  @override
  State<FactoryMaster> createState() => _FactoryMasterState();
}

class _FactoryMasterState extends State<FactoryMaster> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Factory Master', 25, appColors.primaryColor,
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: buildInputColumn2('Manager No.', '1')),
                      SizedBox(width: 10),
                      Expanded(
                          child:
                              buildInputColumn2('Manager Name', 'Ronak Name')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(child: buildInputColumn2('Address', '87025')),
                      SizedBox(width: 10),
                      Expanded(
                          child: buildInputColumn2('Mobile No', '547896321')),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(child: buildInputColumn2('Salary', '87025')),
                      SizedBox(width: 10),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
