...
class RoughFinalEntry extends StatefulWidget {
  const RoughFinalEntry({super.key});

  @override
  State<RoughFinalEntry> createState() => _RoughFinalEntryState();
}

class _RoughFinalEntryState extends State<RoughFinalEntry> {
  int selectedIndex = 0;
  @override
