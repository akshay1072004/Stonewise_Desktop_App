...
class FactoryReport extends StatefulWidget {
  const FactoryReport({super.key});

  @override
  State<FactoryReport> createState() => _FactoryReportState();
}

class _FactoryReportState extends State<FactoryReport> {
  int selectedIndex = 0;
      ...
      child: CommonDialog(
        child: Column(
          children: [
            ...
            textScreen('Factory Stock Report', 25, appColors.primaryColor,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonDropdownButton(
                              items: [
                                'LIVE STOCK REPORT',
                                'PROCESS WISE STOCK REPORT',
                                'FACTORY WISE STOCK REPORT',
                              ],
